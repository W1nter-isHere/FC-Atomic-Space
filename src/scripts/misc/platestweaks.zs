//Tinker Hammer Plate Recipe Removal
recipes.removeByRecipeName("embers:ingotcopper_plate");

recipes.removeByRecipeName("embers:plate_iron");

recipes.removeByRecipeName("embers:ingotlead_plate");

recipes.removeByRecipeName("embers:plate_gold");

recipes.removeByRecipeName("embers:ingotsilver_plate");

recipes.removeByRecipeName("embers:ingotdawnstone_plate");

//Immersive Hammer Plate Removal
...
recipes.removeByRecipeName("immersiveengineering:material/plate_constanstan");
